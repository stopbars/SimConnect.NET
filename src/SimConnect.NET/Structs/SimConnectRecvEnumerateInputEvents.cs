// <copyright file="SimConnectRecvEnumerateInputEvents.cs" company="AussieScorcher">
...
namespace SimConnect.NET
{
    ...
    public struct SimConnectRecvEnumerateInputEvents
    {
        ...
        /// <summary>
        /// Gets or sets the array of SimConnectInputEventDescriptor structures.
        /// </summary>
        public SimConnectInputEventDescriptor[] RgData { get; set; }
    }
}
