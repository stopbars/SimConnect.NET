// <copyright file="SimConnectRecvSimObjectData.cs" company="AussieScorcher">
...
{
    /// <summary>
    /// The <see cref="SimConnectRecvSimObjectData"/> structure is received by the client after a successful call to SimConnect_RequestDataOnSimObject or SimConnect_RequestDataOnSimObjectType.
    /// </summary>
    public struct SimConnectRecvSimObjectData
    {
        ...
        /// <summary>
        /// Gets or sets the first 8-byte element of the data array containing information on a specified object.
        /// </summary>
